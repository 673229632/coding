...
import me.zhangrui.domain.vo.EmailVo;
import me.zhangrui.exception.BadRequestException;
import me.zhangrui.repository.VerificationCodeRepository;
...
public class VerificationCodeServiceImpl implements VerificationCodeService {
    ...
    public EmailVo sendEmail(VerificationCode code) {
        ...
        if(verificationCode == null){
            ...
            emailVo = new EmailVo(Arrays.asList(code.getValue()),"CODING SYSTEM",content);
        ...
        // 存在就再次发送原来的验证码
            ...
            emailVo = new EmailVo(Arrays.asList(verificationCode.getValue()),"CODING SYSTEM",content);
        }
        return emailVo;
    }
