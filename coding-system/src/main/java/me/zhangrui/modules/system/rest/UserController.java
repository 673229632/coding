package me.zhangrui.modules.system.rest;

import me.zhangrui.aop.log.Log;
import me.zhangrui.config.DataScope;
import me.zhangrui.domain.Picture;
import me.zhangrui.domain.VerificationCode;
import me.zhangrui.modules.system.domain.User;
import me.zhangrui.exception.BadRequestException;
import me.zhangrui.modules.system.domain.vo.UserPassVo;
import me.zhangrui.modules.system.service.DeptService;
import me.zhangrui.modules.system.service.RoleService;
import me.zhangrui.modules.system.service.dto.RoleSmallDTO;
import me.zhangrui.modules.system.service.dto.UserQueryCriteria;
import me.zhangrui.service.PictureService;
import me.zhangrui.service.VerificationCodeService;
import me.zhangrui.utils.*;
import me.zhangrui.modules.system.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity getUsers(UserQueryCriteria criteria, Pageable pageable) throws Exception {
        Set<Long> deptSet = new HashSet<>();
        Set<Long> result = new HashSet<>();

        /*if ("email".equals(criteria.getType())) {

            Field field = criteria.getClass().getDeclaredField("blurry");
            Query query = field.getAnnotation(Query.class);
            System.out.println(query.blurry());
            InvocationHandler invocationHandler = Proxy.getInvocationHandler(query);
            Field filterField = query.getClass().getDeclaredField("blurry");
            filterField.setAccessible(true);
            Map memberValues = (Map) filterField.get(invocationHandler);
            memberValues.put("blurry", "email");
        }

        if ("username".equals(criteria.getType())) {
            Field field = criteria.getClass().getDeclaredField("blurry");
            Query foo = field.getAnnotation(Query.class);
            System.out.println(foo.blurry());
        }*/
    ...
    public ResponseEntity updateEmail(@PathVariable String code, @RequestBody User user) {
        ...
        VerificationCode verificationCode = new VerificationCode(code, CodingConstant.RESET_MAIL, "email", user.getEmail());
